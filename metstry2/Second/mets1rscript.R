...
head(track)
#write.csv(track, file = "/home/paul/metstry2/First/mergersReport.csv")
write.table(track, file ="/home/paul/metstry1/metstry2/Second/mergersReport.txt", sep="\t", quote = F)
...
write(asv_fasta, "/home/paul/metstry1/metstry2/Second/ASVs.fa")

# count table:
asv_tab <- t(seqtab.nochim)
row.names(asv_tab) <- sub(">", "", asv_headers)
write.table(asv_tab, "/home/paul/metstry1/metstry2/Second/ASVs_counts.txt", sep="\t", quote=F)

# tax table:
asv_tax <- taxa
row.names(asv_tax) <- sub(">", "", asv_headers)
write.table(asv_tax, "/home/paul/metstry1/metstry2/Second/ASVs_taxonomy.txt", sep="\t", quote=F)
